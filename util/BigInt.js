// BigInteger library from https://github.com/peterolson/BigInteger.js
// Public Domain code
// includes modifications from original to support Require.js as well as importing/exporting BinaryData instances

define(["./BinaryData"], function (BinaryData) {
"use strict";
var bigInt = (function () {
    ...
    BigInteger.prototype.toBinaryData = function () {
        return BinaryData.fromHexString(this.toString(16));
    }
    ...
    var TWO = new BigInteger([2], sign.positive);
    ...
    function parseInput(text) {
        ...
        if (text instanceof ArrayBuffer || ArrayBuffer.isView(text)) {
            return parseBase(new BinaryData(text).toHexString(), 16);
        }
        if (text instanceof BinaryData) return parseBase(text.toHexString(), 16);
    ...
    fnReturn.gcd = gcd;
    fnReturn.lcm = lcm;
    fnReturn.isInstance = function (v) { return v instanceof BigInteger; };
    return fnReturn;
})();
